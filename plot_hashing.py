...
# equivalent to combining the â€œhashing trickâ€ implemented by the
...
# ---------------
#
# In a large text corpus, some words appear with higher frequency (e.g. â€œtheâ€,
# â€œaâ€, â€œisâ€ in English) and do not carry meaningful information about the actual
...
# tfâ€“idf transform as implemented by the
# :func:`~sklearn.feature_extraction.text.TfidfTransformer`. TF stands for
# "term-frequency" while "tfâ€“idf" means term-frequency times inverse
# document-frequency.
#
